...
\usepackage{lipsum}
\usepackage[paperwidth=13cm,paperheight=3.5cm,top=10pt,bottom=10pt,left=0.5cm,right=0.5cm]{geometry}
\usepackage{xltxtra,mflogo,texnames}
\usepackage[backend=biber,style=gb7714-2015,natbib]{biblatex}%sorting=nyt
