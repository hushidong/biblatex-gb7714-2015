...
\usepackage{hyperref}
\usepackage{lipsum}
\usepackage[paperwidth=14cm,paperheight=10.5cm,top=10pt,bottom=10pt,left=0.5cm,right=0.5cm]{geometry}

\usepackage[backend=biber,style=gb7714-2015ms,gbstyle=false,
gbnamefmt=familyahead]{biblatex}%

\defbibheading{subbibliography}[\refname]{%
\centering{\heiti #1}\par%
}
...
\begin{document}
    ...
    \begin{refsection}
    中英文文献\cite{马欢2011-27-27,kiyotaki1997credit,罗德明2012要素市场扭曲,khan2013credit,吕捷2015cpi,IEEEexample:masterstype}

    \printbibliography[heading=subbibliography,title=同一文献表中英文文献不同格式]
    \end{refsection}
\end{document}
