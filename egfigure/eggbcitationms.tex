...
\usepackage[backend=biber,style=gb7714-2015ms,gbfootbib=true,gbalign=gb7714-2015,gbstyle=true,autolang=other*]{biblatex}%sorting=nyt
...
\AtEveryBiblistitem{authorexample}{\localsetchinesecode}
...
\AtEveryBiblistitem{titlexamplea}{\localsetchinesecode}
...
\AtEveryBiblistitem{titlexample}{\localsetchinesecode}
...
\AtEveryBiblistitem{editionexample}{\localsetchinesecode}
...
\AtEveryBiblistitem{pubexample}{\localsetchinesecode}
...
\AtEveryBiblistitem{dateexample}{\localsetchinesecode}
...
\AtEveryBiblistitem{dvnpexample}{\localsetchinesecode}
