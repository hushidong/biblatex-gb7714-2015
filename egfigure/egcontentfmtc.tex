...
\usepackage{lipsum}
\usepackage[paperwidth=14cm,paperheight=11.5cm,top=10pt,bottom=10pt,left=0.5cm,right=0.5cm]{geometry}
...
sortcites,sorting=gbynta]{biblatex}
...
\cite{IEEEexample:frenchpatreq,吕捷2015cpi,杨光2015经济波动}
