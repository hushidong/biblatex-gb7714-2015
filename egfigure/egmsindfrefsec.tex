...
\usepackage{lipsum}
\usepackage[paperwidth=16cm,paperheight=16cm,top=10pt,bottom=10pt,left=0.5cm,right=0.5cm]{geometry}
...
\vspace{-0.5cm}
\printbibliography[heading=subbibliography]%[env=bibliographyay]
\end{refsection}
\vspace{-0.5cm}
