...
\updateinfo[2021-04-11]{date of update: 2021-04-11 to version v1.0y}\label{up:20210411}
...
\item 删掉为作者年份制增加的著录表环境(numerical)，因为gbalign实现了替代。（20210411）

 del the bibliography environment (numerical), because it is substituted by gbalign option.
\end{enumerate}
