...
gbnamefmt=familyahead,sorting=nyt]{biblatex}%
...
\makeatother
    ...
    \section{测试gb7714-2015ms样式中英文不同样式：中英文对照文献}
    \begin{refsection}
