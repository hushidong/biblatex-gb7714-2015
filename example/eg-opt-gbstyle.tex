...
% !Mode:: "TeX:UTF-8"
% 用于测试gb7714-2015ms样式，是否能够在一篇文档中使用两种样式的格式设置
% 即中文文献以GB格式设置，英文文献以biblatex标准样式设置。
...
\usepackage[backend=biber,style=gb7714-2015ms,gbstyle=false,
gbnamefmt=familyahead]{biblatex}%
...
\makeatother
    ...
    \begin{document}
    \section{测试gb7714-2015ms样式中英文不同样式：中文文献}
    \begin{refsection}
    中文文献\cite{中华医学会湖北分会1984--,中国职工教育研究会1985--,abx2007-500-503,张凯军2012-04-05--,张成思2010长期均衡,张伯伟2002--,杨汝岱2015中国制造,杨洪升2013-56-75,杨光2015经济波动,徐伟康2010对,王文甫2010价格粘性,王国静2014金融冲击,汤万金2013-09-30--}

    \printbibliography
    \end{refsection}


    \section{测试gb7714-2015ms样式中英文不同样式：英文文献}
    \begin{refsection}
    英文文献\cite{dataseteg,Misceg,zhang2009china,databaseeg,mapeg,aritileeg,
    softwareeg,archiveeg,Yi2013--,Yi2014--,xu2012role,wang2006another,IEEEexample:uspat,
    saiz2010geographic,ROSENTHALL1963--}

    \printbibliography
    \end{refsection}
    
    \section{测试gb7714-2015ms样式中英文不同样式：中英文混合文献表}
    \begin{refsection}
    中英文文献\cite{马欢2011-27-27,kiyotaki1997credit,罗德明2012要素市场扭曲,khan2013credit,吕捷2015cpi,IEEEexample:masterstype,楼继伟2016改革, jermann2012macroeconomic,刘凤良2017,iacoviello2005house}
    ...
    \section{测试gb7714-2015ms样式中英文不同样式：中英文对照文献表}
    \begin{refsection}
    \defbibentryset{张敏莉，等，2007}{张敏莉2007-500-503,Zhang2007-500-503}

    双语文献:
    考虑条目集方法使用默认样式，而关联条目方法使用语言判断后选择的样式。
    ...
    \section{测试gb7714-2015ms样式中英文不同样式：标注命令}
    \begin{refsection}
     不带页码的引用(上标，方括号包围):
