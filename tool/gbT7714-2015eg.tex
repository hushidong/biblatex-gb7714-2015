...
\makeatletter
\newtoggle{flag:texliveGTtwtw}
\@ifclasslater{2020/04/01}
{
\toggletrue{flag:texliveGTtwtw}
}
{
\togglefalse{flag:texliveGTtwtw}
}
\makeatother
...
%texlive 2021 开始对于gbk支持不好了。
%所以做一个判断，若article是texlive2021以后的版本，都不在添加codeopt
\iftoggle{flag:texliveGTtwtw}{
\phantomsection
