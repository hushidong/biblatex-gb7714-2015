...
下面直接给出最小工作示例用以简单介绍biblatex宏包参考文献生成的一般方法。例\ref{code:doc:structrue}的对应的结果
如图\ref{fig:eg:ref}所示。示例源代码给出了详细注释，说明了使用biblatex的tex文档的基本结构，所有基于biblatex生成参考文献的文档无论大小万变不离其宗，当然除tex文档外另需准备保存参考文献信息的bib文件(详见\ref{sec:bib:bibtex}节)。要更全面深入得了解biblatex参考文献生成，可以参考: biblatex宏包手册\footnote{地址:\url{https://github.com/plk/biblatex}}、
