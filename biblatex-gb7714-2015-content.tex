...
\begin{description}
  ...
  为兼容GBK编码的文档增加的选项。默认设置为false，即默认是utf-8编码的文档。利用pdflatex/latex编译GBK编码文档时，应设置为true。当在源文档前面增加 XeTeX 原语：\lstinline!\XeTeXinputencoding "GBK"! 后，也可以使用xelatex编译，这是应设置为false或者不给出该选项。测试文件见：
