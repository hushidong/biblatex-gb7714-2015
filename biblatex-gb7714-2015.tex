...
\begin{description}
  ...
  \item[\textbackslash addEntryField] \{entrykey or entrykey comma list\}\{field\}\{fieldvalue\}
...
%导言区
%去掉文献 Zhang2007-500-503 的 usera 域
...
gbnamefmt=uppercase,maxcitenames=2,gblocal=gb7714-2015,
