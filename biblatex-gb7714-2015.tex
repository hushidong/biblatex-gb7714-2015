...
图\ref{fig:content:fmtc}给出了选项设置为 style=gb7714-2015ay, maxcitenames=2, mincitenames=1, gbbiblocal, gbcitelocal=chinese, sortcites, sorting=gbyntd 时的引用标注和文献表，可以看到引用标注和文献表中的不同本地化字符串输出效果。
...
\subsection{GB/T 7714-2015 中的参考文献示例}\label{sec:eg:gb77142015}
