...
\usepackage{geometry}
\usepackage[style=gb7714-CCNUay]{biblatex}%,gbalign=right
...
@online{Dublinrawtype,
  ...
  @book{解析数论引论1,
    ...
    @book{解析数论引论2,
    title={解析数论引论},
    author={阿普斯托 and 唐太平 and 阿普斯},
    translator={赵宏量 and 唐太平 and 阿普斯},
    year={2000},
    publisher={哈尔滨工业大学出版社},
    address={哈尔滨},
    pages={1, 132-133}
    ...
    @book{解析数论引论3,
    title={解析数论引论},
    author={阿普斯托 and 唐太平 and 阿普斯 and 普斯托},
    translator={赵宏量 and 唐太平 and 阿普斯 and 普斯托},
    year={2000},
    publisher={哈尔滨工业大学出版社},
    address={哈尔滨},
    pages={1, 132-133}
...
\cite[thm1]{Fothrawtype}

\parencite[thm1]{Fothrawtype}

\citep[thm1]{Fothrawtype}

\citet[thm1]{Fothrawtype}

\textcite[thm1]{Fothrawtype}



\cite{Fothrawtype}

\parencite{Fothrawtype}
...
\parencite{feynman2011feynman}

\citet{feynman2011feynman}

\citep{feynman2011feynman}

\textcite{feynman2011feynman}


\cite{KosekCCNUtype}

\parencite{KosekCCNUtype}

\citet{KosekCCNUtype}

\citep{KosekCCNUtype}

\textcite{KosekCCNUtype}
